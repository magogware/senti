...
export(bool) var enable_open_inertia = false;
export(float, EASE) var open_inertia = 1;
export(bool) var limit_max_closing_speed: bool = false;
export(float, 0, 1.79769e308) var max_closing_speed = 10;
export(bool) var enable_close_inertia = false;
export(float, EASE) var close_inertia = 1;
